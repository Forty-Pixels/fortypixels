...
function HeroGeometric({
    ...
    return (
        <div className="relative min-h-screen w-full flex items-center justify-center overflow-hidden bg-white">
            <div className="absolute inset-0 bg-gradient-to-br from-[#B9FF66]/[0.05] via-transparent to-black/[0.02] blur-3xl" />
            ...
            <div className="relative z-10 container mx-auto px-4 md:px-6">
                <div className="max-w-3xl mx-auto text-center">
                    ...
                    >
                        <Circle className="h-2 w-2 fill-[#B9FF66]" />
                    ...
                    >
                        <p className="text-base sm:text-lg md:text-xl text-gray-600 mb-8 leading-relaxed font-light tracking-wide max-w-xl mx-auto px-4">
                            We build sleek, responsive websites for startups, new businesses, and brands that demand premium design and exceptional results.
                        </p>
                    </motion.div>
                </div>
            </div>
