...
export const metadata:Metadata={title:"Contact",description:"Tell Forty Pixels what you are building and get a clear next step.",alternates:{canonical:"/contact"}};
